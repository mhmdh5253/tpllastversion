(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        : (global = typeof globalThis !== "undefined" ? globalThis : global || self, (global.FormValidation =
            ...
            global.FormValidation.plugins || {}, global.FormValidation.plugins.Trigger =
        ...
        ***************************************************************************** */
        ...
        const Trigger = (function(_super) {
            ...
            Trigger.prototype.prepareHandler = function(field, elements) {
                ...
                elements.forEach(function(ele) {
                    ...
                    events.forEach(function(evt) {
                        const evtHandler = function(e) { return _this.handleEvent(e, field, ele); };
                        _this.handlers.push({
                            element: ele,
                            event: evt,
                            field: field,
            ...
            Trigger.prototype.exceedThreshold = function(field, element) {
                ...
                if (["button", "checkbox", "file", "hidden", "image", "radio", "reset", "submit"].indexOf(type) !==
                    -1) {
                    return true;
                }
