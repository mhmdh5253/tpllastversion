(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        : (global = typeof globalThis !== "undefined" ? globalThis : global || self, (global.FormValidation =
            ...
            global.FormValidation.plugins || {}, global.FormValidation.plugins.Recaptcha3Token =
    ...
    (function(core) {
        ...
        ***************************************************************************** */
         ...
         */
        const Recaptcha3Token = (function(_super) {
            ...
            Recaptcha3Token.prototype.onFormValid = function() {
                ...
                window["grecaptcha"].execute(this.opts.siteKey, { action: this.opts.action }).then(function(token) {
                    ...
                    // Submit the form
                    const form = _this.core.getFormElement();
            ...
            Recaptcha3Token.prototype.getScript = function() {
                ...
                return (`https://www.google.com/recaptcha/api.js?${"onload="
                    .concat(Recaptcha3Token.LOADED_CALLBACK, "&render=").concat(this.opts.siteKey).concat(lang)}`);
            };
