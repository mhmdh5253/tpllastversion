(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        : (global = typeof globalThis !== "undefined" ? globalThis : global || self, (global.FormValidation =
            ...
            global.FormValidation.plugins || {}, global.FormValidation.plugins.Icon = factory(global.FormValidation)));
})(this,
    (function(core) {
        "use strict";
        ...
        ***************************************************************************** */
        ...
        const Icon = (function(_super) {
            ...
            Icon.prototype.onFieldAdded = function(e) {
                ...
                if (elements) {
                    elements.forEach(function(ele) {
                        const icon = _this.icons.get(ele);
                        if (icon) {
            ...
            Icon.prototype.onElementValidating = function(e) {
                var _a;
                const icon = this.setClasses(e.field,
                    e.element,
                    e.elements,
                    (_a = {},
