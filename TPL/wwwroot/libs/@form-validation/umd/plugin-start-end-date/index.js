(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        : (global = typeof globalThis !== "undefined" ? globalThis : global || self, (global.FormValidation =
            ...
            global.FormValidation.plugins || {}, global.FormValidation.plugins.StartEndDate =
    ...
    (function(core) {
        ...
        ***************************************************************************** */
         ...
         */
        const StartEndDate = (function(_super) {
                    ...
                    .addField(this.opts.startDate.field,
                        {
                            validators: {
                                date: {
                                    ...
                                    max: function() {
                                        const endDateField =
                                            form.querySelector("[name=\"".concat(_this.opts.endDate.field, "\"]"));
                                ...
                                date: {
                                    ...
                                    min: function() {
                                        const startDateField =
                                            form.querySelector("[name=\"".concat(_this.opts.startDate.field, "\"]"));
