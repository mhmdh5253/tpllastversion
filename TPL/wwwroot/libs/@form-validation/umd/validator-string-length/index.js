(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        : (global = typeof globalThis !== "undefined" ? globalThis : global || self, (global.FormValidation =
            ...
            global.FormValidation.validators || {}, global.FormValidation.validators.stringLength =
        ...
        function stringLength() {
            return {
                ...
                validate: function(input) {
                    ...
                    const v = opts.trim === true || "".concat(opts.trim) === "true" ? input.value.trim() : input.value;
                    if (v === "") {
                        return { valid: true };
                    }
                    // TODO: `min`, `max` can be dynamic options
                    const min = opts.min ? "".concat(opts.min) : "";
                    const max = opts.max ? "".concat(opts.max) : "";
                    ...
                    case !!min && !!max:
                        ...
                        break;
                    case !!min:
                        msg = format(input.l10n ? opts.message || input.l10n.stringLength.more : opts.message,
                            "".concat(parseInt(min, 10)));
                        break;
                    case !!max:
                        msg = format(input.l10n ? opts.message || input.l10n.stringLength.less : opts.message,
