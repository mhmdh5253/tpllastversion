(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        : (global = typeof globalThis !== "undefined" ? globalThis : global || self, (global.FormValidation =
            ...
            global.FormValidation.plugins || {}, global.FormValidation.plugins.Turnstile =
    ...
    (function(core) {
        ...
        ***************************************************************************** */
        ...
        const Turnstile = (function(_super) {
            ...
            function Turnstile(opts) {
                ...
                _this.captchaContainer =
                    _this.opts.element.startsWith("#") ? _this.opts.element : "#".concat(_this.opts.element);
                return _this;
            }
            ...
            Turnstile.prototype.install = function() {
                ...
                var loadPrevCaptcha = typeof window[Turnstile.LOADED_CALLBACK] === "undefined"
                    ? function() {}
                ...
                window[Turnstile.LOADED_CALLBACK] = function() {
                    ...
                    loadPrevCaptcha();
                    const widgetId = _this.getTurnstileInstance()
                            ...
                            validators: {
                                promise: {
                                    ...
                                    promise: function(input) {
                                        var _a;
                                        const value = _this.widgetIds.has(_this.captchaContainer)
                                            ? _this.getTurnstileInstance()
                                        ...
                                        return fetch(_this.opts.backendVerificationUrl,
                                            ...
                                            .then(function(response) {
                                                const isValid = "".concat(response["success"]) === "true";
            ...
            Turnstile.prototype.uninstall = function() {
                ...
                // Remove script
                const src = this.getScript();
                const scripts = [].slice.call(document.body.querySelectorAll("script[src=\"".concat(src, "\"]")));
            ...
            Turnstile.prototype.getScript = function() {
                return "https://challenges.cloudflare.com/turnstile/v0/api.js?onload=".concat(Turnstile.LOADED_CALLBACK,
                    "&render=explicit");
            };
            ...
            Turnstile.prototype.onResetField = function(e) {
                if (e.field === Turnstile.CAPTCHA_FIELD && this.widgetIds.has(this.captchaContainer)) {
                    const widgetId = this.widgetIds.get(this.captchaContainer);
            ...
            Turnstile.prototype.onIconPlaced = function(e) {
                if (e.field === Turnstile.CAPTCHA_FIELD) {
                    if (this.opts.appearance === "execute") {
                        ...
                        const captchaContainer = document.getElementById(this.captchaContainer);
