(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        : (global = typeof globalThis !== "undefined" ? globalThis : global || self, (global.FormValidation =
            ...
            global.FormValidation.validators || {}, global.FormValidation.validators.choice =
        ...
        function choice() {
            return {
                validate: function(input) {
                    ...
                    const min = input.options.min ? "".concat(input.options.min) : "";
                    const max = input.options.max ? "".concat(input.options.max) : "";
                    var msg = input.l10n ? input.options.message || input.l10n.choice.default : input.options.message;
                    const isValid =
                        !((min && numChoices < parseInt(min, 10)) || (max && numChoices > parseInt(max, 10)));
                    switch (true) {
                    case !!min && !!max:
