(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        : (global = typeof globalThis !== "undefined" ? globalThis : global || self, (global.FormValidation =
            ...
            global.FormValidation.plugins || {}, global.FormValidation.plugins.Recaptcha =
    ...
    (function(core) {
        ...
        ***************************************************************************** */
         ...
         *  ```
         */
        const Recaptcha = (function(_super) {
            ...
            Recaptcha.prototype.install = function() {
                ...
                window[Recaptcha.LOADED_CALLBACK] = function() {
                    ...
                    const widgetId = window["grecaptcha"].render(_this.opts.element, captchaOptions);
                            ...
                            validators: {
                                promise: {
                                    ...
                                    promise: function(input) {
                                        var _a;
                                        const value = _this.widgetIds.has(_this.opts.element)
            ...
            Recaptcha.prototype.getScript = function() {
                const lang = this.opts.language ? "&hl=".concat(this.opts.language) : "";
                return "https://www.google.com/recaptcha/api.js?onload="
                    .concat(Recaptcha.LOADED_CALLBACK, "&render=explicit").concat(lang);
            };
