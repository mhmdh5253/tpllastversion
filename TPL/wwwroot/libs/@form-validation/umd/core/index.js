(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        : (global =
            typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.FormValidation = {}));
})(this,
    (function(exports) {
        "use strict";
        ...
        ***************************************************************************** */
        ...
        function getFieldValue(form, field, element, elements) {
            ...
            if (tagName === "input") {
                if ("radio" === type || "checkbox" === type) {
                    const checked = elements.filter(function(ele) { return ele.checked; }).length;
        ...
        var Core = /** @class */ (function() {
            ...
            Core.prototype.removeField = function(field) {
                if (!this.fields[field]) {
                    throw new Error("The field ".concat(field,
            ...
            Core.prototype.validateField = function(field) {
                ...
                if ("radio" === type || "checkbox" === type || elements.length === 1) {
                    ...
                    return Promise.all(elements.map(function(ele) { return _this.validateElement(field, ele); })).then(
                        function(results) {
                            // `results` is an array of `Valid`, `Invalid` and `NotValidated`
                            switch (true) {
                            case results.indexOf("Invalid") !== -1:
            ...
            Core.prototype.validateElement = function(field, ele) {
                ...
                const promises = Object.keys(validatorList).map(function(v) {
            ...
            Core.prototype.executeValidator = function(field, ele, v, opts) {
                ...
                if (isPromise) {
                    return result.then(function(r) {
                        const data = _this.normalizeResult(field, v, r);
        ...
        const classSet = function(element, classes) {
            var adding = [];
            var removing = [];
        ...
        const fetch = function(url, options) {
            ...
            return new Promise(function(resolve, reject) {
                ...
                const requestUrl = "GET" === opts.method
                    ? "".concat(url).concat(hasQuery ? "&" : "?").concat(params)
                    : url;
                if (opts.crossDomain) {
                    ...
                    script_1.async = true;
                    script_1.addEventListener("load",
                        function() {
                    ...
                    request_1.addEventListener("load",
                        function() {
         ...
         * @returns {string}
         */
        const format = function(message, parameters) {
         ...
         * (c) 2013 - 2023 Nguyen Huu Phuoc <me@phuoc.ng>
         */
        const hasClass = function(element, clazz) {
         ...
         * @returns {boolean}
         */
        const isValidDate = function(year, month, day, notInFuture) {
        ...
        */
        var validators = {};
        const formValidationValidators = function(form, options) {
