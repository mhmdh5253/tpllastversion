(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        : (global = typeof globalThis !== "undefined" ? globalThis : global || self, (global.FormValidation =
            ...
            global.FormValidation.plugins || {}, global.FormValidation.plugins.Message =
        ...
        const Message = (function(_super) {
            ...
            Message.prototype.onFieldAdded = function(e) {
                ...
                if (elements) {
                    elements.forEach(function(ele) {
                        const msg = _this.messages.get(ele);
                        if (msg) {
            ...
            Message.prototype.onFieldRemoved = function(e) {
                ...
                elements.forEach(function(ele) {
                    if (_this.messages.has(ele)) {
                        const container = _this.messages.get(ele);
            ...
            Message.prototype.prepareElementContainer = function(field, element, elements) {
                ...
                if ("string" === typeof this.opts.container) {
                    const selector = "#" === this.opts.container.charAt(0)
            ...
            Message.prototype.onValidatorValidated = function(e) {
                ...
                const element = ("radio" === type || "checkbox" === type) && elements.length > 0
                    ? elements[0]
                    : e.element;
                if (this.messages.has(element)) {
                    const container = this.messages.get(element);
                    const messageEle = container.querySelector("[data-field=\""
