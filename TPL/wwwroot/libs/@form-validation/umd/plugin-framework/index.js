(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        : (global = typeof globalThis !== "undefined" ? globalThis : global || self, (global.FormValidation =
            ...
            global.FormValidation.plugins || {}, global.FormValidation.plugins.Framework =
            factory(global.FormValidation, global.FormValidation.plugins)));
})(this,
    (function(core, pluginMessage) {
        "use strict";
        ...
        ***************************************************************************** */
        ...
        const Framework = (function(_super) {
            ...
            Framework.prototype.install = function() {
                ...
                if (this.opts.defaultMessageContainer) {
                    this.core.registerPlugin(Framework.MESSAGE_PLUGIN,
                        new pluginMessage.Message({
                            clazz: this.opts.messageClass,
                            container: function(field, element) {
                                const selector = "string" === typeof _this.opts.rowSelector
                                    ? _this.opts.rowSelector
                                    : _this.opts.rowSelector(field, element);
                                const groupEle = closest(element, selector);
                                return pluginMessage.Message.getClosestContainer(element,
                                    groupEle,
            ...
            Framework.prototype.onIconPlaced =
                function(_e) {}; // eslint-disable-line @typescript-eslint/no-empty-function
            Framework.prototype.onMessagePlaced =
                function(_e) {}; // eslint-disable-line @typescript-eslint/no-empty-function
            Framework.prototype.onFieldAdded = function(e) {
                ...
                if (elements) {
                    elements.forEach(function(ele) {
                        var _a;
                        const groupEle = _this.containers.get(ele);
                        if (groupEle) {
                            classSet(groupEle,
                                (_a = {},
