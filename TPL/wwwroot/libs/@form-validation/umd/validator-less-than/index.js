(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        : (global = typeof globalThis !== "undefined" ? globalThis : global || self, (global.FormValidation =
            ...
            global.FormValidation.validators || {}, global.FormValidation.validators.lessThan =
        ...
        function lessThan() {
            return {
                validate: function(input) {
                    ...
                    const maxValue = parseFloat("".concat(opts.max).replace(",", "."));
                    return opts.inclusive
                        ? {
                            message: format(input.l10n ? opts.message || input.l10n.lessThan.default : opts.message,
                                "".concat(maxValue)),
