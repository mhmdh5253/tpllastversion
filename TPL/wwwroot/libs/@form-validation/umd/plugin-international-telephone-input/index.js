(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        : (global = typeof globalThis !== "undefined" ? globalThis : global || self, (global.FormValidation =
            ...
            global.FormValidation.plugins || {}, global.FormValidation.plugins.InternationalTelephoneInput =
    ...
    (function(core) {
        ...
        ***************************************************************************** */
         ...
         */
        const InternationalTelephoneInput = (function(_super) {
            ...
            InternationalTelephoneInput.prototype.install = function() {
                ...
                this.fields.forEach(function(field, index) {
                    ...
                    const ele = _this.core.getElements(field)[0];
                    const handler = function() { return _this.core.revalidateField(field); };
                    ...
                    if (index < numHiddenFieldInputs && _this.hiddenFieldInputs[index]) {
                        const hiddenInputEle = document.createElement("input");
            ...
            InternationalTelephoneInput.prototype.uninstall = function() {
                ...
                this.fields.forEach(function(field, index) {
                    ...
                    const handler = _this.countryChangeHandler.get(field);
                    const ele = _this.fieldElements.get(field);
                    const intlTel = _this.getIntTelInstance(field);
                    ...
                    if (index < numHiddenFieldInputs && _this.hiddenFieldInputs[index]) {
                        const hiddenInputEle = _this.hiddenFieldElements.get(field);
                        if (hiddenInputEle) {
            ...
            InternationalTelephoneInput.prototype.checkPhoneNumber = function() {
                ...
                return {
                    validate: function(input) {
                        ...
                        const intlTel = _this.getIntTelInstance(input.field);
                        if (value === "" || !intlTel) {
                            return {
                                valid: true,
                            };
            ...
            InternationalTelephoneInput.prototype.onValidatorValidated = function(e) {
                if (this.hiddenFieldInputs.length === 0 ||
                    e.validator !== InternationalTelephoneInput.INT_TEL_VALIDATOR) {
                    return;
                }
                const field = e.field;
                const hiddenInputEle = this.hiddenFieldElements.get(field);
                if (!hiddenInputEle) {
                    return;
                }
                if (this.isEnabled && e.result.valid) {
                    // Get the intl-tel-input instance
                    const intlTelInstance = this.getIntTelInstance(field);
