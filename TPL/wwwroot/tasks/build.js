...
module.exports = (conf, srcGlob) => {
            ...
            .pipe(
                ...
                gulpIf(
                    ...
                    exec(
                        ...
                        gulpIf(
                            conf.minify,
                            `sass scss:${conf.distPath}/css fonts:${conf.distPath}/fonts libs:${conf.distPath
                            }/libs --style compressed --no-source-map`,
                            gulpIf(
                                conf.fastDev,
                                `sass scss/rtl:${conf.distPath}/css/rtl scss/pages:${conf.distPath}/css/pages fonts:${
                                conf.distPath}/fonts libs:${conf.distPath}/libs --no-source-map`,
                                `sass scss:${conf.distPath}/css fonts:${conf.distPath}/fonts libs:${conf.distPath
                                }/libs --no-source-map`
                            )
                        ),
                ...
                webpack(require("../webpack.config"),
                    (err, stats) => {
                        ...
                        if (stats.hasWarnings()) {
                            info.warnings.forEach(w => log(colors.gray("Webpack compilation warning:"),
                                colors.yellow(w)));
                        }
    ...
    const FONT_TASKS = [
        ...
        },
        {
            ...
            Object.defineProperty(taskFunction,
                "name",
                {
                    value: functionName
                });
